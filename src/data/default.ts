...
["Alcohol", "Being woken up for play", "Blackmail / coercion", "Drugs (legal)", "Drugs (illegal)", "Free use", "Kidnapping", "Rape play", "Sex while asleep"], defaultRating),
...
["Blood", "Blood (drinking)", "Creampie", "Creampie eating (felching)", "Lactation (on body)", "Lactation (drinking)", "Menstruation", "Menstruation (licking)", "Pee", "Pee (body)", "Pee (face)", "Pee (drinking)", "Scat", "Scat (body)", "Scat (face)", "Scat (eating)", "Semen", "Semen (body)", "Semen (face)", "Semen (eating)", "Spit", "Spit (body)", "Spit (face)", "Spit (drinking)", "Squirt", "Squirt (body)", "Squirt (face)", "Squirt (drinking)", "Vaginal fluids", "Vaginal fluids (body)", "Vaginal fluids (face)", "Vaginal fluids (eating)", "Vomit", "Vomit (body)", "Vomit (face)", "Vomit (drinking)"], defaultRating),
